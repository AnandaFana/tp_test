...
from vllm.model_executor.models.debug_helper import DebugDumper  ## change 1
...
class Qwen3MoeDecoderLayer(nn.Module):
    def __init__(self, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        self.layer_idx = extract_layer_index(prefix)  ## change 2
    ...
    def forward(
        ...
        DebugDumper.save(hidden_states, self.layer_idx, "post_attn")  ## change 3

        # Fully Connected
        hidden_states, residual = self.post_attention_layernorm(hidden_states, residual)
        hidden_states = self.mlp(hidden_states)

        DebugDumper.save(hidden_states, self.layer_idx, "post_mlp")  ## change 4
